...
//             <Modal
//               trigger={
//                 <button className="bg-green-700 text-gray-300 rounded-full py-4 px-8 hover:bg-green-600">
//                   Play Now! - Log In
//                 </button>
//               }
//               isLogin={true}
...
//             <Modal
//               trigger={
//                 <button className="bg-purple-800 text-gray-300 rounded-full py-4 px-8 hover:bg-purple-700">
//                   Register
//                 </button>
//               }
//               isLogin={false}
